...
const TARGETS: Target[] = [
  {
    id: "godot",
    label: "Godot 4.x",
    description: "GDScript, project.godot, scene scaffolding + AI player controller",
    icon: "box",
    accentColor: "#478CBF",
    files: ["project.godot", "scenes/main.tscn", "scripts/Player.gd", "assets/", "game-data.json", "README.md"],
  },
  {
    id: "phaser",
    label: "Phaser / HTML5",
    description: "index.html, Phaser 3 bootstrap + AI player script",
    icon: "globe",
    accentColor: "#22C55E",
    files: ["index.html", "src/Player.js", "assets/", "game-data.json", "README.md"],
  },
  {
    id: "unity",
    label: "Unity",
    description: "C# GameData.cs + AI PlayerController script",
    icon: "layers",
    accentColor: "#AAAAAA",
    files: ["Scripts/GameData.cs", "Scripts/PlayerController.cs", "Assets/", "game-data.json", "README.md"],
  },
  {
    id: "gamemaker",
    label: "GameMaker Studio 2",
    description: "GML project + Player Create/Step events",
    icon: "triangle",
    accentColor: "#E7B74E",
    files: ["project.yyp", "objects/Player/Create_0.gml", "objects/Player/Step_0.gml", "sprites/", "game-data.json", "README.md"],
  },
  {
    id: "construct",
    label: "Construct 3",
    description: "c3proj + AI-generated event sheet JSON",
    icon: "grid",
    accentColor: "#00AFF0",
    files: ["project.c3proj", "game-scene.json", "images/", "game-data.json", "README.md"],
  },
  {
    id: "unreal",
    label: "Unreal Engine 5",
    description: "C++ header, .uproject, asset folder structure",
    icon: "cpu",
    accentColor: "#0E1128",
    files: ["Project.uproject", "Source/GameData.h", "Source/PlayerCharacter.cpp", "Content/", "game-data.json", "README.md"],
  },
  {
    id: "rpgmaker",
    label: "RPG Maker MZ",
    description: "JS plugin + full story/combat data for events",
    icon: "book-open",
    accentColor: "#C0392B",
    files: ["js/plugins/GenForgePlugin.js", "js/plugins/GenForgeGameplay.js", "img/", "game-data.json", "README.md"],
  },
  {
    id: "generic",
    label: "Generic / JSON",
